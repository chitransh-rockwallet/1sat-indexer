...
import (
	...
	"github.com/chitransh-rockwallet/1sat-indexer/v5/server/routes/acct"
	"github.com/chitransh-rockwallet/1sat-indexer/v5/server/routes/blocks"
	"github.com/chitransh-rockwallet/1sat-indexer/v5/server/routes/evt"
	"github.com/chitransh-rockwallet/1sat-indexer/v5/server/routes/origins"
	"github.com/chitransh-rockwallet/1sat-indexer/v5/server/routes/own"
	"github.com/chitransh-rockwallet/1sat-indexer/v5/server/routes/spend"
	"github.com/chitransh-rockwallet/1sat-indexer/v5/server/routes/sse"
	"github.com/chitransh-rockwallet/1sat-indexer/v5/server/routes/tag"
	"github.com/chitransh-rockwallet/1sat-indexer/v5/server/routes/tx"
	"github.com/chitransh-rockwallet/1sat-indexer/v5/server/routes/txos"
)
