...
import (
	...
	"github.com/chitransh-rockwallet/1sat-indexer/server/routes/acct"
	"github.com/chitransh-rockwallet/1sat-indexer/server/routes/blocks"
	"github.com/chitransh-rockwallet/1sat-indexer/server/routes/evt"
	"github.com/chitransh-rockwallet/1sat-indexer/server/routes/origins"
	"github.com/chitransh-rockwallet/1sat-indexer/server/routes/own"
	"github.com/chitransh-rockwallet/1sat-indexer/server/routes/spend"
	"github.com/chitransh-rockwallet/1sat-indexer/server/routes/sse"
	"github.com/chitransh-rockwallet/1sat-indexer/server/routes/tag"
	"github.com/chitransh-rockwallet/1sat-indexer/server/routes/tx"
	"github.com/chitransh-rockwallet/1sat-indexer/server/routes/txos"
