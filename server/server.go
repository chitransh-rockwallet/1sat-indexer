...
import (
	...
	"github.com/chitransh-rockwallet/1sat-indxer/server/routes/acct"
	"github.com/chitransh-rockwallet/1sat-indxer/server/routes/blocks"
	"github.com/chitransh-rockwallet/1sat-indxer/server/routes/evt"
	"github.com/chitransh-rockwallet/1sat-indxer/server/routes/origins"
	"github.com/chitransh-rockwallet/1sat-indxer/server/routes/own"
	"github.com/chitransh-rockwallet/1sat-indxer/server/routes/spend"
	"github.com/chitransh-rockwallet/1sat-indxer/server/routes/sse"
	"github.com/chitransh-rockwallet/1sat-indxer/server/routes/tag"
	"github.com/chitransh-rockwallet/1sat-indxer/server/routes/tx"
	"github.com/chitransh-rockwallet/1sat-indxer/server/routes/txos"
